...
pygame.mixer.init()
son_check = pygame.mixer.Sound(resource_path("Son/Check.MP3"))
son_faux = pygame.mixer.Sound(resource_path("Son/Faux.MP3"))
son_victoire = pygame.mixer.Sound(resource_path("Son/Victoire.mp3"))
